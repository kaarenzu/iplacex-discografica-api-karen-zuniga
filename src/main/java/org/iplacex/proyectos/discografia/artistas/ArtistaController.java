...
@RestController
@RequestMapping("/api") // Permite generar una url general para el controlador
@CrossOrigin // Permitir los origenes cruzados
public class ArtistaController {

    @Autowired
    private IArtistaRepository artistaRepo;

    // Metodo para agregar artista a la db
    ...
    public ResponseEntity<Artista> HandleInsertArtistaRequest(@RequestBody Artista artista) {
        ...
        Artista temp = artistaRepo.insert(artista);// propiedad interna tem, el metodo que usamos para insertar un
                                                   // registro devuelve objeto tipo temp
